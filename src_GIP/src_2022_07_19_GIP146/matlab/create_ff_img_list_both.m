...
OUT_DIR_RGB = 'C:\alon\datasets\Agriculture-Vision\train_ff\rgb\';
OUT_DIR_NIR = 'C:\alon\datasets\Agriculture-Vision\train_ff\nir\';
OUT_DIR_LBL = 'C:\alon\datasets\Agriculture-Vision\train_ff\gt_labels\';
...
for n = 1:num_fields  %1:num_fields   7 45 
    ...
    for ii = 1 : SKIP : h-IMG_SIZE+1
        for jj = 1 : SKIP : w-IMG_SIZE+1
