...
def build_backbone(backbone, output_stride, ibn_mode, BatchNorm, pretrained=True):
    if backbone == 'resnet50':
        return resnet.ResNet50(output_stride, ibn_mode, pretrained=pretrained)
    if backbone == 'resnet101':
        return resnet.ResNet101(output_stride, ibn_mode, pretrained=pretrained)
