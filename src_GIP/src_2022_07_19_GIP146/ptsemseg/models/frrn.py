...
class frrn(nn.Module):
    ...
    def __init__(self, n_classes=21, n_channels=3, model_type="B", group_norm=False, n_groups=16):
        ...
        if self.group_norm:
            self.conv1 = conv2DGroupNormRelu(self.n_channels, 48, 5, 1, 2)
        else:
            self.conv1 = conv2DBatchNormRelu(self.n_channels, 48, 5, 1, 2)
