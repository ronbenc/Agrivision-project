...
class agrivision6Loader_pseudo(agrivision6Loader):
    ...
    def __init__(self,
                ...
                img_norm=False,
                test_mode=False):
        super(agrivision6Loader_pseudo, self).__init__(root, split, img_list, img_size, n_channels, augmentations, debug_info, img_norm, test_mode)
    ...
    def __getitem__(self, index):
        ...
        lbl_path = os.path.join(self.root, split_dir, 'pseudo_labels', prefix + '.png')
...
class agrivision6Loader_agct_pseudo(agrivision6Loader_agct):
    ...
    def __init__(self,
                 ...
                 test_mode=False,
                 agct_params=None):
        super(agrivision6Loader_agct_pseudo, self).__init__(root, split, img_list, img_size, n_channels, augmentations,
                                                     debug_info, img_norm, test_mode, agct_params)
