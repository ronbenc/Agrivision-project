...
class unet_atrous(nn.Module):
    def __init__(
        self, n_classes=19, is_deconv=True, n_channels=3, is_batchnorm=True, smooth_layers=0, atrous_dilations = [1,2,4,8], atrous_layers = [0,0,0,0,0], kernel_size = [3,3,3,3,3]):
