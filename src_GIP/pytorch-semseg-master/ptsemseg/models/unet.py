...
class unet(nn.Module):
    def __init__(
        self, n_classes=17, is_deconv=True, n_channels=3, is_batchnorm=True, smooth_layers=0):
        ...
        # downsampling
        self.conv1 = unetConv2(self.n_channels, n_maps[0], self.is_batchnorm)
        self.maxpool1 = nn.MaxPool2d(kernel_size=2)

        self.conv2 = unetConv2(n_maps[0], n_maps[1], self.is_batchnorm)
        self.maxpool2 = nn.MaxPool2d(kernel_size=2)

        self.conv3 = unetConv2(n_maps[1], n_maps[2], self.is_batchnorm)
        self.maxpool3 = nn.MaxPool2d(kernel_size=2)

        self.conv4 = unetConv2(n_maps[2], n_maps[3], self.is_batchnorm)
        self.maxpool4 = nn.MaxPool2d(kernel_size=2)

        self.center = unetConv2(n_maps[3], n_maps[4], self.is_batchnorm)

        # upsampling
        self.up_concat4 = unetUp(n_maps[4], n_maps[3], self.is_deconv)
        self.up_concat3 = unetUp(n_maps[3], n_maps[2], self.is_deconv)
        self.up_concat2 = unetUp(n_maps[2], n_maps[1], self.is_deconv)
        self.up_concat1 = unetUp(n_maps[1], n_maps[0], self.is_deconv)
