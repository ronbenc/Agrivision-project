...
%     %%% compare with prev
%     prev_label_file = ['C:\alon\datasets\Agriculture-Vision\val\full_field\',prefix,'_gt_label.png'];
...
%     tagstruct.ExtraSamples = Tiff.ExtraSamples.Unspecified;  %   UnassociatedAlpha
