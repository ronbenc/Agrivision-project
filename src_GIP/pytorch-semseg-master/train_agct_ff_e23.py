...
from ptsemseg.loader.agrivision6_loader_full_field import agrivision6Loader_full_field, agri6_ff_exp_23
...
def train(cfg):
    ...
    agct_params = cfg.get("agct", None)

    t_loader = agri6_ff_exp_23(
        data_path,
    ...
    model = get_model(cfg["model"], n_classes, n_channels, agct_params, correct_block).to(device)
